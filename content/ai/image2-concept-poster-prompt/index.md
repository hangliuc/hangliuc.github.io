---
title: "Image2 提示词｜构建视觉隐喻的高级概念海报"
description: "一份可复用的 Image2 图片生成提示词：从词语含义出发，用极简构图、强排版与视觉隐喻表达文字的精神状态。"
image: cover.png
...
这份提示词用于 Image2 生成概念海报。重点是先理解文字的含义与情绪，再让文字和图像共同构成一个完整的视觉表达。

## 使用方法

复制下方完整提示词，填写末尾的「核心文字 / 单词 / 词组 / 字母」。背景、补充语境和情绪倾向可以按需调整；默认文字语言为中文，情绪倾向为「专业 / 压迫感 / 醒目」。

## 完整提示词

```text
你要生成的不是一个单词放大后贴在画面上的字效海报，而是一张“基于词语含义自动构建视觉隐喻”的高级概念海报。
